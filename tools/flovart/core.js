...
export const HELP_TEXT = [
  ...
  '',
  'Compatibility commands remain callable and discoverable with command.list and command.schema.',
  'MCP is an optional projection; CLI + Skill is the default external-Agent path.',
].join('\n');
