export interface NormalsFromDepthOptions {
  /** gradient strength multiplier; default 1.0 */
  strength?: number;
  /** invert depth; default false (white=near in MiDaS maps) */
  invert?: boolean;
}
